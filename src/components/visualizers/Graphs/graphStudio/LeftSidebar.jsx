...
const ZoomValueInput = ({ value, disabled, onCommit }) => {
  ...
  return (
    <span
      className={joinClasses(
        'flex h-8 w-full items-center justify-center rounded-sm border border-[#CBD5E1] bg-[#FFFFFF] px-1 text-[#334155] transition-colors focus-within:border-[#0F2747] focus-within:ring-1 focus-within:ring-[#0F2747] dark:border-[#475569] dark:bg-[#0F172A] dark:text-[#E2E8F0] dark:focus-within:border-[#60A5FA] dark:focus-within:ring-[#60A5FA]',
        disabled &&
  ...
  return (
    ...
    >
      ...
      <SidebarSection>
        ...
        <div
          className="grid grid-cols-[minmax(64px,1fr)_32px_56px_32px] items-center gap-1.5 rounded-sm border border-[#D7DEE8] bg-[#FFFFFF] px-2 py-1.5 dark:border-[#475569] dark:bg-[#111827]"
