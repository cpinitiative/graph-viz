  ...
  return (
    ...
    >
      ...
      <SidebarSection>
        ...
        <div
          className="grid grid-cols-[minmax(64px,1fr)_32px_56px_32px] items-center gap-1.5 rounded-sm border border-[#D7DEE8] bg-[#FFFFFF] px-3 py-1.5 dark:border-[#475569] dark:bg-[#111827]"
