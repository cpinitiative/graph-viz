...
const toolButtonActiveClass =
  'border-[#1D4ED8] bg-[#0F2747] font-bold text-[#FFFFFF] shadow-none hover:bg-[#12345F] dark:border-[#60A5FA] dark:bg-[#1E3A8A] dark:text-[#FFFFFF] dark:hover:bg-[#1D4ED8]';
const iconButtonClass =
  'flex h-9 w-9 shrink-0 items-center justify-center rounded-sm border border-[#D7DEE8] bg-[#FFFFFF] p-1.5 text-[#334155] transition-colors hover:bg-[#EEF2F6] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0F2747] disabled:cursor-not-allowed disabled:bg-[#F8F9FA] disabled:text-[#94A3B8] dark:border-[#475569] dark:bg-[#1E293B] dark:text-[#E2E8F0] dark:hover:bg-[#334155] dark:focus-visible:ring-[#60A5FA] dark:disabled:bg-[#111827] dark:disabled:text-[#64748B]';
