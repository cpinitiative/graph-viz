...
export const DEFAULT_GRAPH = {
    ...
    edges: [
        { id: 'e0', from: 0, to: 1, color: '#77777766', duration: 450, directed: false, label: '2', visible: true },
        { id: 'e1', from: 1, to: 2, color: '#77777766', duration: 450, directed: false, label: '4', visible: true },
        { id: 'e2', from: 0, to: 3, color: '#77777766', duration: 450, directed: false, label: '7', visible: true },
        { id: 'e3', from: 3, to: 4, color: '#77777766', duration: 450, directed: false, label: '3', visible: true },
    ],
};
